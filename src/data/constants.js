...
import antlogo from "../images/antdesignlogo.png";
import claylogo from "../images/clay_logo.png";
import formiklogo from "../images/formiklogo.png";
import render from "../images//render.png";
import rtklogo from "../images/RTKlogo.jpg";
import tailwindlogo from "../images/tailwindcsslogo.png";
import typescriptlogo from "../images/typescriptlogo.png";
import vuelogo from "../images/vuejslogo.png";
...
export const Bio = {
  ...
  facebook: "https://www.facebook.com/ritik.beriwal.16",
};
...
export const education = [
  {
    id: 0,
    img: lpu,
    school: "Lovely Professional University, Punjab(online)",
    date: "2023 - 2025(result awaited)",
    grade: "7.9 CGPA",
    desc: "MCA (Web Development) focuses on designing, developing, and deploying scalable full-stack web applications using modern technologies. The program emphasizes advanced JavaScript, frontend frameworks, backend architecture, RESTful APIs, database design, authentication, and performance optimization, with strong hands-on experience through real-world, project-based learning.",
    degree:
      "Master in Computer Application - MCA, Web Development (Majors: CS and IT)",
  },
  {
    id: 1,
    img: Trinity,
    ...
    grade: "8.9 CGPA",
    desc: "Bachelor of Computer Applications (BCA) provided a strong foundation in computer science, programming, and software development. Gained hands-on experience in web development, database management, and problem-solving using modern tools and technologies.",
    degree: "Bachelor in Computer Application - BCA, ",
  },
  {
    id: 2,
    img: SrsMission,
    school: "Dr SRS Mission School, B-1 Janakpuri",
    date: "Apr 2014 - Apr 2015",
    grade: "70%",
    desc: "I completed my class 12 education at Dr SRS Mission School, B-1 Janakpuri, Delhi, where I studied Commerce with Information Practical.",
    degree: "CBSE(XII), Commerce With IP",
  },
];
...
export const projects = [
  {
    ...
    description:
      "YouTube like Interface having Hamburger Menu, Video Cards, Search Box, Comments Section Live Chat.",
    image: playtubeimg,
    tags: [
      "React JS",
      "Redux",
  ...
  },
  {
    ...
    description:
      "Web Application for managing the projects and get the information of particular projects like it’s supervisor, assignee, etc.",
    image:
